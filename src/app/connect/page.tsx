          ...
          {submitted ? (
            <div className="text-center p-16 border border-[var(--border)] bg-[var(--card-bg)]">
              ...
              <p className="text-[var(--muted)] leading-relaxed">
                Thank you for connecting with us. A member of our team will reach out 
                to you shortly to help you get settled into the church family.
              </p>
              <button
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="firstName" className="block text-[10px] uppercase tracking-[0.2em] text-[var(--muted)] font-semibold mb-3">
                    First Name *
                  </label>
                  <input
                    id="firstName"
                ...
                <div>
                  <label htmlFor="lastName" className="block text-[10px] uppercase tracking-[0.2em] text-[var(--muted)] font-semibold mb-3">
                    Last Name *
                  </label>
                  <input
                    id="lastName"
              ...
              <div>
                <label htmlFor="address" className="block text-[10px] uppercase tracking-[0.2em] text-[var(--muted)] font-semibold mb-3">
                  Address
                </label>
                <input
                  id="address"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="age" className="block text-[10px] uppercase tracking-[0.2em] text-[var(--muted)] font-semibold mb-3">
                    Age Group
                  </label>
                  <select
                    id="age"
                ...
                <div>
                  <label htmlFor="howDidYouHear" className="block text-[10px] uppercase tracking-[0.2em] text-[var(--muted)] font-semibold mb-3">
              ...
              {/* Interests */}
              <div>
                <label className="block text-[10px] uppercase tracking-[0.2em] text-[var(--muted)] font-semibold mb-4">
                  I&apos;m interested in
                </label>
                <div className="grid grid-cols-2 gap-3">
                  {interestOptions.map((interest) => (
                    <button
                      ...
                      className={`p-3 text-sm border transition-all duration-300 text-left ${
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full p-4 border border-[var(--border)] bg-[var(--background)] text-[var(--foreground)] text-sm resize-none focus:border-[var(--purple)] focus:outline-none transition-colors"
                />
              </div>
