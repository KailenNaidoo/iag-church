    ...
    <PageTransition>
      <section className="py-32 px-6 text-center relative overflow-hidden noise-bg">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <p className="text-[9px] uppercase tracking-[0.4em] text-[var(--accent)] font-sans font-medium mb-5">Become Family</p>
          <h1 className="text-4xl md:text-7xl font-serif font-normal mb-6">Connect</h1>
          <p className="text-base text-[var(--muted-light)] font-light max-w-xl mx-auto">We&apos;d love to welcome you into the IAG family.</p>
        </div>
      </section>
