          ...
          <ScrollReveal>
            ...
            <div className="aspect-video bg-gradient-to-br from-[#0c1a2e] to-[#081220] border border-[var(--border)] flex items-center justify-center relative overflow-hidden">
              ...
              <div className="text-center text-white relative z-10">
                <div className="w-20 h-20 mx-auto mb-6 border-2 border-white/20 rounded-full flex items-center justify-center hover:border-[var(--gold)] hover:scale-110 transition-all duration-300 cursor-pointer">
                  <svg className="w-8 h-8 ml-1 opacity-70" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <ScrollReveal key={platform.title} delay={i * 0.15}>
